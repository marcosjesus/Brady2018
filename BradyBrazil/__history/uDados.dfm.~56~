object Fr_Dados: TFr_Dados
  ...
  object FDManager: TFDManager
    ...
    Active = True
    AfterLoadConnectionDefFile = FDQueryTSOP_OrderBillingNewRecord
    Left = 104
    Top = 81
  end
      ...
      item
        ...
        SQL.Strings = (
          ...
          'FROM TMAQ_ItemBOM A01'
            ...
            'WHERE  MONTH(A01.TMAQ_ITEBOMDAT) = MONTH(DATEADD(MONTH, -1, GETD' +
            'ATE()))'
          
            '  AND YEAR(A01.TMAQ_ITEBOMDAT)   = YEAR( DATEADD(MONTH, -1, GETD' +
            'ATE()))')
      end>
    Connection = FDConnection
    Params = <>
      ...
      item
        ...
        SQL.Strings = (
          ...
          'FROM TMAQ_ItemRouting A01'
            ...
            'WHERE  MONTH(A01.TMAQ_ITEROUDAT) = MONTH(DATEADD(MONTH, -1, GETD' +
            'ATE()))'
          
            '  AND YEAR(A01.TMAQ_ITEROUDAT)   = YEAR( DATEADD(MONTH, -1, GETD' +
            'ATE()))')
      end>
    Connection = FDConnection
    Params = <>
